        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12">              
              <div class="card">
                ...
                <div class="card-body">
                  @hasrole('admin')
                  <form class="form-horizontal" method="post" action="{{url('report-pegawai/filter')}}" enctype="multipart/form-data">
                  @endhasrole
                  @hasrole('dispatcher_unit')
                  <form class="form-horizontal" method="post" action="{{url('report-pegawai-unit/filter')}}" enctype="multipart/form-data">
                  @endhasrole
                    @csrf
            ...
            <!-- <?php if(!empty($rekap))
            {
              ...
              <div class="card">
                <div class="card-header card-header-info">
                  <h4 class="card-title ">DAFTAR TIKET PER IT SUPPORT</h4>
